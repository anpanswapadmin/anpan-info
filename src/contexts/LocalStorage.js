...
const UPDATABLE_KEYS = [LIGHT_MODE, DISMISSED_PATHS, SAVED_ACCOUNTS, SAVED_PAIRS, SAVED_TOKENS]
...
export function useLightModeManager() {
  const [state, { updateKey }] = useLocalStorageContext()
  let isLightMode = state[LIGHT_MODE]
  const toggleLightMode = useCallback(
    (value) => {
      updateKey(LIGHT_MODE, value === false || value === true ? value : !isLightMode)
    },
    [updateKey, isLightMode]
  )
