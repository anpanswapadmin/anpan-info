...
interface ReturnMetrics {
  ...
  anpanswapReturn: number // netReturn - hodlReturn
  impLoss: number
  fees: number
}
...
const PRICE_DISCOVERY_START_TIMESTAMP = 1627750800
...
export function getMetricsForPositionWindow(positionT0: Position, positionT1: Position): ReturnMetrics {
  ...
  const anpanswap_return = difference_fees_usd + imp_loss_usd
  ...
  return {
    ...
    anpanswapReturn: anpanswap_return,
