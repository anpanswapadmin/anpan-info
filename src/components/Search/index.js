...
import { useAllPairsInAnpanswap, useAllTokensInAnpanswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInAnpanswap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInAnpanswap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search AnpanSwap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
        ...
        <div>
          ...
          {filteredPairList &&
            filteredPairList.slice(0, pairsShown).map((pair) => {
              ...
              updateNameData(pair)
              return (
                <BasicLink to={'/pool/' + pair.id} key={pair.id} onClick={onDismiss}>
                  <MenuItem>
